...
public class ComplaintListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (jsonObject.has("title")) {
            title = (jsonObject.optString("title")).toUpperCase();
        }
        ...
        if (jsonObject.has("upvote_count")) {
            upCount = jsonObject.optString("upvote_count");
        }

        if (jsonObject.has("downvote_count")) {
            downCount = jsonObject.optString("downvote_count");
        }
